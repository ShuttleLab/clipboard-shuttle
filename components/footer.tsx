...
const CURRENT_HOST = "clipboard.shuttlelab.org";
...
const TOOL_PAGES: { href: string; labelKey: string }[] = [
  { href: "/tools/cross-device-clipboard", labelKey: "toolCrossDeviceClipboard" },
  { href: "/tools/phone-to-computer", labelKey: "toolPhoneToComputer" },
];
